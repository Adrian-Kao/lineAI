...
const MESSAGES = {
  'zh-TW': {
    ...
    'story.back': '返回任務頁', 'story.kicker': '萬春宮 · 任務完成', 'story.title': '{task}的小故事', 'story.fallback': '完成「{task}」後，你在萬春宮留下了一段探索記錄。沿著任務一步步前進，這趟文化小旅行也多了一個值得回看的片段。', 'story.imageAlt': '萬春宮探索紀錄', 'story.imagePending': '圖片待補：需使用具來源／授權的素材。', 'story.source': '來源：', 'story.demoSource': '萬春宮 DEMO 活動流程紀錄', 'story.backMap': '返回地圖',
  },
  en: {
