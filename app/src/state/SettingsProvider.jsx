...
const MESSAGES = {
  'zh-TW': {
    ...
    'friends.add': '新增好友', 'friends.addAction': '加入好友', 'friends.search': '搜尋', 'friends.phone': '電話', 'friends.lineId': 'LINE ID', 'friends.lookupType': '好友搜尋方式',
    ...
    'friends.demoLookup': '好友搜尋', 'friends.demoNote': 'DEMO 版會搜尋專案內的測試使用者；正式版需由後端驗證電話或遊戲內 LINE ID。', 'friends.empty': '目前還沒有好友', 'friends.emptyHelp': '新增好友後，就能在這裡比較彼此的文化探索進度。',
  ...
  en: {
    ...
    'friends.add': 'Add friend', 'friends.addAction': 'Add', 'friends.search': 'Search', 'friends.phone': 'Phone', 'friends.lineId': 'LINE ID', 'friends.lookupType': 'Friend search method',
    ...
    'friends.demoLookup': 'Friend search', 'friends.demoNote': 'The DEMO searches local test users. The production version will verify phone numbers or in-game LINE IDs through the backend.', 'friends.empty': 'No friends yet', 'friends.emptyHelp': 'Add a friend to compare your cultural exploration progress.',
